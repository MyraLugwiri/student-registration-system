...
print("")
try:
    user_id = input("Enter your ID(IB***): ")
    name = input("Enter your name(firstname & lastname): ")
    email = input("Enter your email (firstnameinitial.lastname@agblschool.com): ")
    role = input("Enter your role in the school: ")
    ...
    if option == 1:
        ...
        register.register(ID, std_name, std_email, roles, dob, age, gender, parent_name, parent_contact, address, doA)
    elif option == 2:
